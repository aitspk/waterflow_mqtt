...
const char* ssid     = "XXXX-YOUR-WIFI---xxx";
const char* password = "some-password";
const char* mqtt_server = "192.168.1.100"; // IP Address of MQTT Server
const int mqttPort = 1883;
const char* mqttUser = "user"; // MQTT Auth Username
const char* mqttPassword = "password"; // MQTT Password
const char* clientID = "WaterTap"; // MQTT ClientID
const char* outTopic = "home/sensor/WaterTap1"; //Topic for output
const char* inTopic = "home/sensor/WaterTap1"; //Topic for input

// Update these with values suitable for your network.
IPAddress server(192, 168, 1, 100); // MQTT Server ip address duplicate don;t know why it is here
